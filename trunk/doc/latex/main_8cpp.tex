...
\label{main_8cpp}\index{main.cpp(149)@{main.cpp(149)}}
}
...
\begin{Desc}
\item[\hyperlink{todo__todo000001}{Todo}]Develop a method to remove a pixel from the list of seeds \end{Desc}
\begin{Desc}
