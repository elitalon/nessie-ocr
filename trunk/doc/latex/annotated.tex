...
\item\contentsline{section}{\hyperlink{class_data_set}{DataSet} (Data set of character samples encoded as feature vectors )}{\pageref{class_data_set}}{}
\item\contentsline{section}{\hyperlink{class_feature_vector}{FeatureVector} (Vector of features that defines a character in an image )}{\pageref{class_feature_vector}}{}
