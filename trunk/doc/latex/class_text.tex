...
\paragraph[{computeWordRates}]{\setlength{\rightskip}{0pt plus 5cm}void Text::computeWordRates (const std::string \& {\em delimiters} = {\tt \char`\"{}~,:¡!.;()¿?$\backslash$\char`\"{}'\mbox{[}\mbox{]}\{\}$<$$>$$\backslash$$\backslash$$|$\char`\"{}})\hspace{0.3cm}{\tt  \mbox{[}private\mbox{]}}}\hfill}
