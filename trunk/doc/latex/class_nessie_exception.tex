...
Definition at line 20 of file NessieException.h.\subsection*{Public Member Functions}
...
\item[Parameters:]
\begin{description}
\item[{\em what}]A string containing a message that explains the exception raised\end{description}
\end{Desc}
\begin{Desc}
\item[Author:]Eliezer Talón (\href{mailto:elitalon@gmail.com}{\tt elitalon@gmail.com}) \end{Desc}
\begin{Desc}
...
\item 
\hyperlink{_nessie_exception_8h}{NessieException.h (123)}\item 
\hyperlink{_nessie_exception_8cpp}{NessieException.cpp (123)}\end{CompactItemize}
