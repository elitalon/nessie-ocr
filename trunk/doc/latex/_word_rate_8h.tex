...
\label{_word_rate_8h}\index{WordRate.h(111)@{WordRate.h(111)}}
}
...
\begin{center}
\leavevmode
\includegraphics[width=193pt]{_word_rate_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Typedefs}
\begin{CompactItemize}
\item 
typedef pair$<$ string, unsigned int $>$ \hyperlink{_word_rate_8h_e8f43926daba5798edbb3cb94ad07ff7}{WordRate}
\begin{CompactList}\small\item\em Appearance rate of a word. \item\end{CompactList}\end{CompactItemize}


\subsection{Typedef Documentation}
\hypertarget{_word_rate_8h_e8f43926daba5798edbb3cb94ad07ff7}{
\index{WordRate.h@{WordRate.h}!WordRate@{WordRate}}
\index{WordRate@{WordRate}!WordRate.h@{WordRate.h}}
\subsubsection[WordRate]{\setlength{\rightskip}{0pt plus 5cm}typedef pair$<$string, unsigned int$>$ {\bf WordRate}}}
\label{_word_rate_8h_e8f43926daba5798edbb3cb94ad07ff7}
