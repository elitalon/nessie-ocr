...
An iterator to a list of LineMarker objects. 
...
\index{Segmenter@{Segmenter}!findSpaceLocations@{findSpaceLocations}}
\index{findSpaceLocations@{findSpaceLocations}!Segmenter@{Segmenter}}
...
\index{Segmenter@{Segmenter}!spaces@{spaces}}
\index{spaces@{spaces}!Segmenter@{Segmenter}}
