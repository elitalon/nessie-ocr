...
///
/// @details Initializes a Clip object located at coordinates (row,column) in the source image, with the height and width passed.
/// 
		...
		height_(height)
{
	if ( (height == 0) and (width == 0) )
		throw NessieException ("Clip constructor has 0 size");
	
	if ( width > imageWidth )
		throw NessieException ("Clip width cannot be wider than underlying image's width");
